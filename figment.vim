...
syn region figQuoted matchgroup=figQuotation     start=/\<q[a-z](/             end=/)/                contains=figUnquote,figEscape
syn region figQuoted matchgroup=figQuotation     start=/\<q[a-z]\[/            end=/]/                contains=figUnquote,figEscape
syn region figQuoted matchgroup=figQuotation     start=/\<q[a-z]{/             end=/}/                contains=figUnquote,figEscape
...
syn region figLiteralQuoted matchgroup=figLiteralQuotation     start=/\<q[A-Z](/             end=/)/
syn region figLiteralQuoted matchgroup=figLiteralQuotation     start=/\<q[A-Z]\[/            end=/]/
syn region figLiteralQuoted matchgroup=figLiteralQuotation     start=/\<q[A-Z]{/             end=/}/
